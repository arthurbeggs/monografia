...
\resumo{resumo}{
{ 
    Desenvolvimento de um processador com arquitetura do conjunto de instruções
    RISC-V em Verilog sintetizável em FPGA para ser utilizado como recurso de
    laboratório para a disciplina de Organização e Arquitetura de Computadores
    da Universidade de Brasília. O processador contará com perifericos e.g.
    saída de vídeo para proporcionar um ambiente completo de desenvolvimento
