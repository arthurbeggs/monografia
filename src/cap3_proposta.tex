...
\section{Implementação dos \textit{soft-cores}}
    ...
    \subsection{Microarquitetura Uniciclo}
        ...
        { A instrução recuperada da memória de instruções \texttt{core/memory/CodeMemory\_Interface}
            no endereço do registrador \texttt{PC} é lida pela unidade de controle
            \texttt{core/risc\_v/Control\_UNI.v}, que gera todos os sinais de
            controle enviados ao caminho de dados \texttt{core/risc\_v/Datapath\_Uni.v}.
        ...
        { Exceto o roteamento extra do banco de registadores de ponto flutuante
            \texttt{core/risc\_v/FRegisters.v} e da ULA de ponto flutuante de
            precisão simples \texttt{core/risc\_v/FPULA/FPALU.v}, o restante do
            circuito segue as mesmas conexões.
        }
