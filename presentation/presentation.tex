...
\setbeamertemplate{title page}{
    \begin{figure}[H]
        \begin{subfigure}
        \raggedright
            \includegraphics[width=.35\textwidth,height=.1\textheight,keepaspectratio]{../images/unb/unb.jpg}
        \end{subfigure}
        \hspace{.4\textwidth}
        \begin{subfigure}
        \raggedleft
            \includegraphics[width=.35\textwidth,height=.08\textheight,keepaspectratio]{../images/unb/ft.png}
        \end{subfigure}
    \end{figure}
    \bigskip
    \centering
